...
export default function App() {
  ...
  return (
    <div className="min-h-screen w-full px-3 pt-6 pb-24 safe-area-inset flex flex-col">
      ...
      <nav className="fixed bottom-4 left-3 right-3 h-16 rounded-3xl flex justify-around items-center backdrop-blur-md bg-white/70 dark:bg-black/30 border-t border-black/10 dark:border-white/10 safe-area-inset-bottom">
        <Link
          to="/home"
